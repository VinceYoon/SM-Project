		...
		<section class="type01">
			...
			<div class="group01">
				...
				<div class="list_detail">
					<!-- s: form -->
					<form id="frmEdit" name="frmEdit" method ="post" action="/login/userEditFormAjax">
						<ul>
							<li>
								<dt>아이디 </dt>
								<dd>
						...
						<ul class="list_detail_more">
							...
							<li>
								...
								<div class="module_partner_ly" style="overflow-y: scroll; height:400px; width:400px;display:none">
